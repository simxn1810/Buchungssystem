  ...
  return (
    <div className="prose prose-sm max-w-none">
      ...
      <p className="text-sm text-gray-500">
        Platzhalter – bitte vor dem Live-Gang durch die offizielle Datenschutzerklaerung des
        Vereins ersetzen bzw. mit der bestehenden Erklaerung unter{" "}
      ...
      <p>
        {VEREIN.name}, {VEREIN.adresse}. E-Mail: {VEREIN.email}.
      </p>
